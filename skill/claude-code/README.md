...
2. **`fabrica verify-hook`** (above) makes "is this actually working" a question the Client can answer on demand, rather than something a broken install could silently un-answer for him.
